...
$string['view_others_entries'] = 'Review Entries';
...
$string['goodhabits:view_others_entries'] = 'Access the review features of this plugin to view the entries of other users';
$string['goodhabits:review_others'] = 'Read entries belonging to a particular other user';
$string['goodhabits:manage_activity_habits'] = 'Manage Activity Habits - I.e. ones that are set up for all users in the activity';
