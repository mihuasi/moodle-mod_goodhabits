...
$string['allow_review_peers'] = 'Allow peers to review your tracker data (and you to see theirs)';
$string['allow_review_peers_help'] = 'Allows others on the course to see your tracker data. <br /><br />If you enable this, you will be able to see the habit tracker data of the other users who have opted in.';
$string['allow_review_admin'] = 'Allow admin to review your tracker data';
$string['allow_review_admin_help'] = 'Allows admin to review your tracker data. <br /><br />That is, the ratings you have given yourself.';
